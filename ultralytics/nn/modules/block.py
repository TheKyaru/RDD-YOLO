...
class Bottleneck_IDC(Bottleneck):
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        super().__init__(c1, c2, shortcut, g, k, e)
        c_ = int(c2 * e)  # hidden channels
        self.cv1 = Conv2d_IDC(c1)
        self.cv2 = Conv2d_IDC(c2)

class C3k_IDC(C3k):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=3):
        super().__init__(c1, c2, n, shortcut, g, e, k)
        c_ = int(c2 * e)  # hidden channels
        self.m = nn.Sequential(*(Bottleneck_IDC(c_, c_, shortcut, g, k=(k, k), e=1.0) for _ in range(n)))

class C3k2_IDC(C3k2):
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        super().__init__(c1, c2, n, c3k, e, g, shortcut)
        self.m = nn.ModuleList(C3k_IDC(self.c, self.c, 2, shortcut, g) if c3k else Bottleneck_IDC(self.c, self.c, shortcut, g) for _ in range(n))